...
NetworkGame::NetworkGame(RakServer& server, const std::shared_ptr<NetworkPlayer>& leftPlayer,
			const std::shared_ptr<NetworkPlayer>& rightPlayer, PlayerSide switchedSide,
